...
TRAINING_VIDEOS_LIST = [i for i in range(1, 11)]  # ex: 1, 2, 3
...
# ===============================
# 전체 라벨 목록 파일
LABELS_LIST_PATH = os.path.join(LABELS_DIR, "labels_list.txt")

# USE_WORD_NUM 만큼 필터링된 라벨 파일
USE_LABELS_LIST_PATH = os.path.join(LABELS_DIR, f"labels_list.txt")
