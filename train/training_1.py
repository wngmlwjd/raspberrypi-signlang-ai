...
from models.cnn_1 import build_cnn_model_keras
...
def train():
    ...
    model = build_cnn_model_keras(
        input_size=max_joints * 3,   # feature 차원
        seq_len=None,                # 영상 단위 전체 시퀀스 → None
        num_classes=num_classes,
        conv_channels=CONV_CHANNELS,
        conv_kernel=CONV_KERNEL,
        dense_hidden=GRU_HIDDEN,     # 기존 GRU hidden 사용
    ...
    earlystop_cb = EarlyStopping(monitor='val_loss', patience=5, verbose=1, restore_best_weights=True)
